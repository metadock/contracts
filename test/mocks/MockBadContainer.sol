...
/// @title MockBadContainer
/// @notice Container that reverts when receiving native tokens (ETH)
contract MockBadContainer is IContainer, ModuleManager {
