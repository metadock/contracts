...
contract Execute_Unit_Concrete_Test is Workspace_Unit_Concrete_Test {
    ...
    function test_RevertWhen_CallerNotOwner() external {
        ...
        // Run the test
        workspace.execute({ module: address(mockModule), value: 0, data: "" });
    }
    ...
    function test_RevertWhen_ModuleNotEnabled() external whenCallerOwner {
        ...
        workspace.execute({ module: address(0x1), value: 0, data: "" });
    }
    ...
    function test_Execute() external whenCallerOwner whenModuleEnabled {
        ...
        // Run the test
        workspace.execute({ module: address(mockModule), value: 0, data: data });
        ...
        // Run the test
        workspace.execute({ module: address(mockModule), value: 0, data: wrongData });
    }
}
