...
contract CreateInvoice_TranchedStream_Integration_Fuzz_Test is CreateInvoice_Integration_Shared_Test {
    ...
    function testFuzz_CreateInvoice_TranchedStream(
        uint8 recurrence,
        address recipient,
        uint40 startTime,
        uint40 endTime,
        ...
        whenPaymentAssetNotNativeToken
    {
        ...
        recurrence = uint8(bound(recurrence, uint8(Types.Recurrence.Weekly), uint8(Types.Recurrence.Yearly)));
        ...
        invoice = createFuzzedInvoice(
            Types.Method.TranchedStream, Types.Recurrence(recurrence), recipient, startTime, endTime, amount
        );
