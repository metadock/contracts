...
contract CreateInvoice_LinearStream_Integration_Fuzz_Test is CreateInvoice_Integration_Shared_Test {
    ...
    function testFuzz_CreateInvoice_LinearStream(
        address recipient,
        uint40 startTime,
        uint40 endTime,
        uint128 amount
    ...
    {
        Types.Recurrence recurrence = Types.Recurrence.OneOff;
        ...
        invoice = createFuzzedInvoice(Types.Method.LinearStream, recurrence, recipient, startTime, endTime, amount);
