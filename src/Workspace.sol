...
/// @title Workspace
/// @notice See the documentation in {IWorkspace}
contract Workspace is IWorkspace, AccountCore, ERC1271, ModuleManager {
    ...
    /// @notice Initializes the {ModuleKeeper}, enables initial modules and configures the {Workspace} smart account
    function initialize(address _defaultAdmin, bytes calldata _data) public override {
        ...
        // Initialize the {Workspace} smart contract
