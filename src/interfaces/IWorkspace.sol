...
interface IWorkspace is IERC165, IERC721Receiver, IERC1155Receiver {
    /*//////////////////////////////////////////////////////////////////////////
                                       EVENTS
    //////////////////////////////////////////////////////////////////////////*/
    ...
    /// @notice Emitted when a `value` amount of ERC-1155 `id` tokens are withdrawn from the workspace
    /// @param to The address to which the tokens were transferred
    ...
    ///
    /// Requirements:
    /// - `msg.sender` must be the owner of the workspace
    ///
